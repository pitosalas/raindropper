...
collection_keywords = {
    ...
    "software engineering": {
        "automation", "pip", "package", "library", "async", "concurrency", "unittest", "virtualenv", "venv", "import", "module", "pandas", "numpy", "matplotlib", "scipy", "flask", "django", "fastapi", "cli", "shell", "terminal", "repl", "algorithm", "datastructure", "debug", "test", "devops", "REST", "typing", "git", "github", "database", "databases",  "dbms", "programmer", "coder", "developer", "markdown", "docker", "linux", "unix", "mock", "mocking", "tdd", "software", "hardware", "architecture", "object-oriented", "object", "pattern", "ACM", "http", "tcp", "udp", "tdd", "rails"
        "", "django", "flask", "fastapi", "php", "coroutines", "co-routines", "heroku", "fly.io", "environment", "applicatoin", "system", "rss", "dotfiles", "volume", "plugins", "server", "aws", "serverless", "plug-ins", "vscode", "authentication", "oauth", "SQL", "jquery", "torrent", "graphql", "ssl", "node", "npm", "bytes", "SOA", "CLI", "refactor", "refactoring", "debugger", "debugging", "postgres", "regexp", "regexpr", "regexper", "sinatra", "rack", "stack", "stacks", "queues", "agile", "scrum", "streamlit", "monitor", "API", "domain", "algorithms", "computer", "monolith", "QR"
    }, 
    "programming": {
